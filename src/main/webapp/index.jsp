        ...
        <div id="app" class="container">
            ...
            <div id="home">
                <main class="hero">
                    <div class="hero-content">
                        ...
                        <p>
                            ...
                            one pet but also freeing up space for another animal in need.
                        </p>
                    ...
                    <div class="hero-images">
                        ...
                        <img src="images/white-cat.png" alt="Cat illustration" class="cat1-image" />
                        <img src="images/black-cat.png" alt="Cat illustration" class="cat2-image" />
                    </div>
                </main>
                <div>
                    <h1 class="section-title">Why You Should <span>Choose Us ?</span></h1>
                ...
                <section class="how-it-section">
                    <img src="images/takecare.png" alt="Take care of your pet" />
                ...
                <section class="how-it-section reverse">
                    <img src="images/vt.png" alt="Veterinary care" />
                    <div class="text-content">
            ...
            <div id="explore" class="explore">
                <h1 class="section-title">Explore Our <span class="highlight">Cats</span></h1>
            ...
            <div id="support" class="support">
                <div>
                    <img class="support-banner" src="images/support_banner.jpg" alt="Support Image" />
                </div>
                ...
                <section class="how-it-section">
                    <div class="support-img">
                        <img class="" src="images/heart_donation.png" alt="Donation" />
                    </div>
                    <div class="text-content">
                ...
                <section class="how-it-section">
                    <div class="support-img">
                        <img class="" src="images/question.png" alt="Why support" />
                    </div>
                    <div class="text-content">
                ...
                <section class="how-it-section">
                    <div class="support-img">
                        <img class="" src="images/bkash_logo.png" alt="bKash" />
                    </div>
                    <div class="text-content">
                        <h2>How to Donate</h2>
                        <p>
                        ...
                        <ul class="support-list">
                            <li>
                                bKash Number:
                                <span style="font-family: consolas; border: 1px solid #ccc; margin-left: 2px; padding: 2px 4px; font-weight: bold;">
                                    01630844517
                                </span>
                            </li>
                            <li>Account Type: Personal</li>
                            <li>
                                Reference: Nekodop Donation<small> (Please mention this during payment)</small>
                            </li>
                        </ul>
                    </div>
                </section>
            ...
            <div id="contact">
                <div class="contact-container">
                    <section class="form-section">
                        ...
                        <form action="https://formsubmit.co/siddiqsazzad001@gmail.com" method="POST">
                            <div class="form-row">
